function Sutils()
{
	...
	{
		$alert.info("Sutils 1.0.3 - Written by speedyplane2447 (c) speedyplane2247 2017-2018\nWith Help from: DracoZ12"); // anyone who makes major contributations gets this
	}
